...
alter table if exists public.dealers
  ...
  add column if not exists insurance_assistance boolean default false,
  add column if not exists rc_transfer_help boolean default false,
  add column if not exists test_drive_available boolean default false,
