...
export default async function DealsOfTheWeekPage() {
    ...
    <main className="home exclusive">
      ...
      <section className="exclusive-hero">
        ...
        <div className="exclusive-hero__content">
          <div>
            <p className="exclusive-hero__eyebrow">Deals of the Week</p>
            <h1>
            ...
            <div className="exclusive-hero__actions">
              ...
              <Link className="btn btn--glass" href="/dealer-admin/login">
                Dealer login
              </Link>
            </div>
            <div className="exclusive-hero__trust">
              <span>✓ Weekly featured drops</span>
              <span>✓ Video-first presentation</span>
              <span>✓ Fast buyer contact</span>
            </div>
          ...
          <aside className="exclusive-hero__spotlight">
            <p className="exclusive-hero__spotlight-eyebrow">Weekly spotlight</p>
            <h2>Curated inventory. New drop every week.</h2>
            <ul>
      ...
      <section className="section" id="exclusive-deals">
        <div className="section__header section__header--split">
          <div>
            <h2>Live deals this week</h2>
            <p>Hand-picked cars with fresh promotional videos.</p>
          </div>
          <span className="section-pill">Weekly feature page</span>
        </div>
        {deals.length === 0 ? (
